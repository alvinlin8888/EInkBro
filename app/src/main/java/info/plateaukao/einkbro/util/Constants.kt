...
class Constants {
    companion object {
        //AL-20231003*[
        const val DEFAULT_HOME_URL = "https://carepro.moh.gov.zm/" // "https://carepro-training.ihmafrica.com" //"https://scplus.moh.gov.zm:8080/#/" // "https://www.google.com/"
        const val DEFAULT_HOME_URL2 = "https://scplus.moh.gov.zm:8080/#/"
        const val PROP_BROWSER_URL = "persist.app.browser.url"
        const val URL_EXT_PFX = "732";
        var DefaultHomeUrl = DEFAULT_HOME_URL
        //const val DEFAULT_HOME_URL = "https://www.thinkbroadband.com/download" // https://testfiledownload.com/
        //const val DEFAULT_HOME_URL = "https://testfiledownload.com/" // "https://www.thinkbroadband.com/download" // https://testfiledownload.com/
        //AL-20231003*]
        ...
        const val EN_AUTO_RUN = false //AL-20231003+
        const val EN_WAITING = true //AL-20231003+
        const val EN_GAMMA = false //AL-20231003+
        const val GAMMA_SET_IDX = 7 //AL-20231003+, -1:Disabled, >=0:Gamma index, default=7(Gamma4.00)
        /*
        #0: Gamma0.10
        #1: Gamma0.25
        #2: Gamma0.45
