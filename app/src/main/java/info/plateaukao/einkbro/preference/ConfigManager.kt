...
class ConfigManager(
    ...
    var enableTouchTurn by BooleanPreference(sp, K_ENABLE_TOUCH, true) //AL-20231003*, false->true
    ...
    var favoriteUrl by StringPreference(sp, K_FAVORITE_URL, Constants.DefaultHomeUrl) //Al-20231003-
