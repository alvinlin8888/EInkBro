...
//import info.plateaukao.einkbro.view.toolbaricons.ToolbarAction.Font //AL-20231003-
//import info.plateaukao.einkbro.view.toolbaricons.ToolbarAction.FullScreen //AL-20231003-
...
//import info.plateaukao.einkbro.view.toolbaricons.ToolbarAction.RotateScreen //AL-20231003-
...
//import info.plateaukao.einkbro.view.toolbaricons.ToolbarAction.Tts //AL-20231003-
...
class ComposeToolbarViewController(
    ...
    private val TAG="ComposeToolbarView" //AL-20231003+
    private val config: ConfigManager by inject()
    private val ttsManager: TtsManager by inject()

    private val readerToolbarActions: List<ToolbarAction> = listOf(
        //RotateScreen, //AL-20231003-
        //FullScreen, //AL-20231003-
        BoldFont,
        //Font, //AL-20231003-
        Touch,
        TOC,
    ...
    //fun show() = toggleIconsOnOmnibox(true) //AL-20231003-

    fun show() = {
        Log.i(TAG, "[ComposeToolbarView.show]") //AL-20231003+
        toggleIconsOnOmnibox(true)
    }


    //fun hide() = toggleIconsOnOmnibox(false) //AL-20231003-

    fun hide() = {
        Log.i(TAG, "[ComposeToolbarView.hide]") //AL-20231003+
    ...
    private fun List<ToolbarAction>.toToolbarActionInfoList(): List<ToolbarActionInfo> {
        return this.map { toolbarAction ->
            when (toolbarAction) {
                ...
                //Tts -> ToolbarActionInfo(toolbarAction, ttsManager.isSpeaking()) //AL-20231003-
