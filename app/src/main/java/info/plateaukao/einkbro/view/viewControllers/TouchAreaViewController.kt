...
class TouchAreaViewController(
    ...
    private val TAG ="TouchAreaViewController" //AL-20231003+
    ...
    private fun updateTouchAreaType() {
        ...
        Log.i(TAG, String.format("[updateTouchAreaType] touchAreaType=%s", config.touchAreaType)) //AL-20231003+
    ...
    fun toggleTouchPageTurn(enabled: Boolean) {
        Log.i(TAG, String.format("[toggleTouchPageTurn]")) //AL-20231003+
